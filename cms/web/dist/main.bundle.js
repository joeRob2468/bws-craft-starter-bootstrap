...
if($('.section-qgive_form--block').length){Promise.all(/*! import() | qgive-form */[__webpack_require__.e("vendors~contact-form~qgive-form"), __webpack_require__.e("qgive-form")]).then(__webpack_require__.bind(null, /*! ./block-modules/QGiveForm */ "./src/js/block-modules/QGiveForm.js")).then(function(module){var QGiveForm=module.default;if($(QGiveForm.selector).length){var qgiveForm=new QGiveForm();qgiveForm.init();_this2.content_block_modules.push(qgiveForm);}});}}// Runs every time a new page replaces the current one
