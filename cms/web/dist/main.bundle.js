...
/******/ 		return __webpack_require__.p + "" + ({"formie-form":"formie-form","vendors~contact-form~modal-popup~qgive-form":"vendors~contact-form~modal-popup~qgive-form","modal-popup":"modal-popup","qgive-form":"qgive-form","vendors~contact-form":"vendors~contact-form","contact-form":"contact-form","vendors~events-slider~image-gallery":"vendors~events-slider~image-gallery","events-slider":"events-slider","image-gallery":"image-gallery","vendors~icons-library":"vendors~icons-library","icons-library":"icons-library"}[chunkId]||chunkId) + ".bundle.js"
/******/ 	}
/******/
...
if($('.section-contact_form--block').length){Promise.all(/*! import() | contact-form */[__webpack_require__.e("vendors~contact-form~modal-popup~qgive-form"), __webpack_require__.e("vendors~contact-form"), __webpack_require__.e("contact-form")]).then(__webpack_require__.bind(null, /*! ./block-modules/ContactForm */ "./src/js/block-modules/ContactForm.js")).then(function(module){var ContactForm=module.default;if($(ContactForm.selector).length){var contactForm=new ContactForm();contactForm.init();_this2.content_block_modules.push(contactForm);}});}// init image gallery
if($('.section-image_gallery--block').length){Promise.all(/*! import() | image-gallery */[__webpack_require__.e("vendors~events-slider~image-gallery"), __webpack_require__.e("image-gallery")]).then(__webpack_require__.bind(null, /*! ./block-modules/ImageGallery */ "./src/js/block-modules/ImageGallery.js")).then(function(module){var ImageGallery=module.default;if($(ImageGallery.selector).length){var imageGallery=new ImageGallery();imageGallery.init();_this2.content_block_modules.push(imageGallery);}});}// init events slider
if($('.section-events_slider--block').length){Promise.all(/*! import() | events-slider */[__webpack_require__.e("vendors~events-slider~image-gallery"), __webpack_require__.e("events-slider")]).then(__webpack_require__.bind(null, /*! ./block-modules/EventsSlider */ "./src/js/block-modules/EventsSlider.js")).then(function(module){var EventsSlider=module.default;if($(EventsSlider.selector).length){var eventsSlider=new EventsSlider();eventsSlider.init();_this2.content_block_modules.push(eventsSlider);}});}// init formie form
