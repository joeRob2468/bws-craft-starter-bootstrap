...
if($('.section-formie_form--block').length){__webpack_require__.e(/*! import() | formie-form */ "formie-form").then(__webpack_require__.bind(null, /*! ./block-modules/FormieForm */ "./src/js/block-modules/FormieForm.js")).then(function(module){var FormieForm=module.default;if($(FormieForm.selector).length){var formieForm=new FormieForm();formieForm.init();_this2.content_block_modules.push(formieForm);}});}}// Runs every time a new page replaces the current one
